...
<head>
	<meta charset="utf-8">
	<title>Member: Bui Dinh Xuan</title>
			...
			<div class="row">
				<div class="col">
					...
					<div class="profile-infor d-flex flex-column align-items-center justify-content-center">
						<h2 class="profile-name">Bùi Đình Xuân</h2>
					...
					<div class="profile-detail">
						...
						<div class="d-flex">
							<div class="info-left flex-grow-1">
								...
								<p class="profile-desc">19110320</p>
								<h4>Địa chỉ email</h4>
								<p class="profile-desc">19110320@student.hcmute.edu.vn</p>
								<h4>Sở thích</h4>
							...
							<div class="info-right flex-grow-1">
								...
								<p class="profile-desc">Viết báo cáo</p>								
							</div>
						</div>
					</div>
				</div>
