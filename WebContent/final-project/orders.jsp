	...
	<main>
		<div class="sidebar d-flex flex-column flex-shrink-0 text-white bg-dark" style="width: 280px;">
		    ...
		    <ul class="nav nav-pills flex-column mb-auto px-3">
		      	...
		      	<li class="nav-item">
		        	<a href="<c:url value='/admin/orders'/>" class="nav-link active" aria-current="page">
		...
		<div class="side-wrapper" style="width: 100%; background-color: #edf3f9;">
			...
			<div class="container side-content">
				<div class="row">
					<div class="col-md-12">
						<div class="py-2">
							<h4 class="text-capitalize">List Orders</h4>
						</div>
								...
								<table class="table table-hover">
									...
									<tbody>
										<c:forEach var="reservation" items="${reservations}" varStatus="loop">
											<tr>
												<td>${loop.count}.</td>
												<td class="fw-bold"><c:out value="${reservation.username}"/></td>	
												<td class="fw-bold"><c:out value="${reservation.email}"/></td>
