					...
					<div class="col-md-12">
						<div class="table-wrapper" style="background-color: #fff!important;">
							<div class="py-2" style="border: 1px solid #ccc;">
								<h4 class="text-capitalize ps-3">${account.username}</h4>
							</div>
							<div class="profile-info p-3" style="border: 1px solid #ccc;
								box-shadow: 0 0.5rem 1rem rgb(0 0 0 / 5%), inset 0 -1px 0 rgb(0 0 0 / 15%);">
								<form action="<c:url value='/admin/edit-admin-profile'/>" method="post">
									<div class="mb-2">
										<label class="form-label" for="name">Name</label>
										<input class="form-control" type="text" name="name" value="${account.username}">
									</div>
									<div class="mb-2">
									...
									<div class="d-flex justify-content-end me-3">
										...
										<a href="<c:url value='/admin/admin-profile'/>" class="btn btn-danger">Cancel</a>
									</div>
								</form>									
							</div>
						</div>
