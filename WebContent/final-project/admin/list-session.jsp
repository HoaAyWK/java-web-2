		...
		<div class="side-wrapper" style="width: 100%; background-color: #edf3f9;">
			...
			<div class="container side-content" style="margin-top: 60px;">
				<div class="row">
					<div class="col-md-12">
						<div class="py-2">
							<h4 class="text-capitalize">List Session</h4>
						</div>
						<div class="table-wrapper" style="background-color: #fff!important;">							
							<div class="profile-info" style="border: 1px solid #ccc;
								...
								<div class="float-end py-2 pe-2">
									<a class="btn btn-success" href="<c:url value='/admin/sessions/add'/>">
									...
									<tbody>
										<c:forEach var="showtime" items="${showtimes}" varStatus="loop">
											<tr>
												...
												<td>${showtime.date}</td>
												<td>${showtime.seatsAvailable}</td>
												<td>
													<div class="d-flex justify-content-center align-items-center" 
														style="width: 100%; height: 100%;">
														<form action="" method="post" class="mx-1">
															<input type="hidden" name="action" value="delete">
															<input type="hidden" name="id" value="<c:out value='${showtime.id}'/>">
