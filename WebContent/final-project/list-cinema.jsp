		...
		<div class="side-wrapper" style="width: 100%; background-color: #edf3f9;">
			...
			<div class="container side-content">
				<div class="row">
					<div class="col-md-12">
						<div class="py-2">
							<h4 class="text-capitalize">List Cinema</h4>
						</div>
						<div class="table-wrapper" style="background-color: #fff!important;">							
							<div class="profile-info" style="border: 1px solid #ccc;
								...
								<div class="float-end py-2 pe-2">
									<a class="btn btn-success" href="<c:url value='/admin/cinemas/add'/>">
								...
								<table class="table table-hover">
									...
									<tbody>
										<c:forEach var="cinema" items="${cinemas}" varStatus="loop">
											<tr>
												<td>${loop.count}.</td>
												<td class="fw-bold"><c:out value="${cinema.name}"/></td>	
												...
												<td>
													<div class="d-flex justify-content-center align-items-center" 
														...
														<form action="" method="post" class="mx-1">
															...
															<input type="hidden" name="id" value="<c:out value='${cinema.id}'/>">
