 ...
 */
@WebServlet(name = "UserProfileServlet", urlPatterns = {"/movietickets/profile"})
public class UserProfileServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		getServletContext().getRequestDispatcher("/final-project/user/user-profile.jsp").forward(request, response);
